...
\includegraphics[height=.4\linewidth]{figs/amazonAndImagenet-linint-vs-alpha_C1_fc8.pdf}
\label{fig:linint-eval}
}
\subfigure[Unsupervised Methods]{
\includegraphics[height=.4\linewidth]{figs/amazonAndImagenet-sa_gfk_dim_C1_fc7.pdf}
