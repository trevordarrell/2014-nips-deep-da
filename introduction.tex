...
Evaluation for image category classification across visually distinct domains has focused on the standard benchmark Office dataset, which contains 31 image categories and 3 domains \cite{saenko-eccv10}. 
...
of relevant layers. In contrast, ImageNet has roughly 100 times more data per category then the domains in the office dataset.
