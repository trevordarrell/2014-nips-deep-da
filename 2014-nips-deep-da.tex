...
Thus, to combat this bias, we also propose a suite of methods for performing adaptation with deep models.
...
In contrast, training or fine-tuning a state-of-the-art deep model on a new domain requires a significant amount of data, which for many applications is simply not available.
