...
\subsection{Selecting a Layer with A-Distance}
...
shown in \et{a table that hasn't been created yet}. It turns out that using the
...
\et{I'd like to generate a plot that shows that A-distance is a reasonable
proxy for adaptation performance, but I haven't done so yet. That discussion
would go here once it happens, though.}
